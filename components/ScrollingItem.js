...
export default class ScrollingItem extends React.Component {
    constructor() {
        super();
    ...
    render() {
        ...
        return (
            <View style={{ height: this.props.wrapperHeight, width: this.props.wrapperWidth, backgroundColor: this.props.wrapperBackground, borderTopColor: this.props.highlightColor, borderBottomColor: this.props.highlightColor, borderTopWidth: this.props.highlightBorderWidth, borderBottomWidth: this.props.highlightBorderWidth }}>
